...
namespace CovidBot.Dialogs
{
    public class UserDetailsDialog : CancelAndHelpDialog
    {
        ...
        private Task<DialogTurnResult> AddressStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
        ...
        private async Task<DialogTurnResult> NameStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            string ask = "Sorry we are covid, Please give us the required details for us to track easy";
